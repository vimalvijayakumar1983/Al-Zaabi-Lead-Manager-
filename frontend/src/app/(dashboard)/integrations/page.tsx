...
const GoogleAdsIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none">
    <path d="M3.287 18.578l5.576-9.655 4.011 6.941-3.565 6.17a3.29 3.29 0 01-4.5 1.203 3.29 3.29 0 01-1.522-4.659z" fill="#FBBC04"/>
    <path d="M21.713 18.578L16.137 8.923 8.863 8.923 14.439 18.578a3.29 3.29 0 004.5 1.203 3.29 3.29 0 002.774-1.203z" fill="#4285F4"/>
    <path d="M16.137 8.923l5.576-9.655a3.29 3.29 0 00-1.203-4.5 3.29 3.29 0 00-4.5 1.203L8.863 8.923h7.274z" fill="#34A853"/>
    <circle cx="5.808" cy="18.578" r="3.29" fill="#EA4335"/>
  </svg>
);
